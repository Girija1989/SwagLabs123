...
public class App {
  ...
  public void f() throws InterruptedException {
	  ...
	  ChromeOptions options = new ChromeOptions();
		...
		WebElement men = driver.findElement(By.id("testMenuSelect-shop-men"));
		System.out.println("Men Tab is Opened");
		act.moveToElement(men).build().perform();
		WebElement women = driver.findElement(By.id("testMenuSelect-shop-women"));
		act.moveToElement(women).build().perform();
		System.out.println("Women tab is Opened");
		WebElement mobiles = driver.findElement(By.id("testMenuSelect-mobile covers"));
		act.moveToElement(mobiles).build().perform();
		System.out.println("Mobiles Cover is Opened");
		WebElement men1 = driver.findElement(By.id("testMenuSelect-shop-men"));
		act.moveToElement(men1).build().perform();
		System.out.println("Men Tab is Opened"); // To Scroll the SrollbarUp and Down:
		Thread.sleep(2000);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("window.scrollBy(0,500)");
		Thread.sleep(3000);
		jse.executeScript("window.scrollBy(0,-300)"); // Selecting the Product from Men: 
		driver.findElement(By.xpath("//span[text( )='Henleys']")).click();
		...
		try {
			 ...
			 * "//div[@class='SizeModal']/child::button")));
			 */
			List<WebElement> size1 = driver.findElements(By.xpath("//div[@class='SizeModal']/child::button"));
			String value = "S";
			for (WebElement sizes : size1) {
		...
		System.out.println("No.of Quantities" + qty.size());
		String str = "10";
		...
		WebElement colour=driver.findElement(By.xpath("//div[@id='testColorBlock-0']/span"));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='testColorBlock-0']/span")));
		colour.click();
		...
		WebElement pouches=driver.findElement(By.xpath("//span[@class='cartCount']"));
		wait.until(ExpectedConditions.elementToBeClickable(pouches));
		pouches.click();
